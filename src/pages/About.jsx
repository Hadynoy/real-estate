...
const About = () => {
  return (
    <section className="bg-[#0a0f1c] text-white py-32 relative overflow-hidden">
      {/* Background Layers */}
      <div className="absolute inset-0 bg-[url('/src/assets/luxury-pattern.svg')] opacity-5 mix-blend-overlay -z-10"></div>
      <div className="absolute top-0 left-0 right-0 h-96 bg-gradient-to-b from-[#d4af37]/10 to-transparent -z-10"></div>
      <div className="absolute bottom-0 left-0 right-0 h-96 bg-gradient-to-t from-[#d4af37]/10 to-transparent -z-10"></div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <Home className="text-[#d4af37] animate-pulse drop-shadow-[0_0_6px_#d4af37aa]" size={24} />
            <span className="w-12 h-0.5 bg-[#d4af37]"></span>
          </div>
          ...
          <p className="text-lg text-[#d4af37]/70 font-serif mt-2 tracking-wide">
            Since 1998
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              <h3 className="text-3xl font-serif font-medium text-white mb-6">
                Where <span className="text-[#d4af37]">Excellence</span> Meets <span className="text-[#d4af37]">Elegance</span>
              </h3>
              <div className="absolute -left-4 top-0 w-1.5 h-32 bg-[#d4af37]/30"></div>
            </div>

            <p className="text-lg text-white/80 leading-relaxed">
              For nearly three decades, UrbanNest has been the pinnacle of luxury real estate, 
              curating exclusive access to the world's most extraordinary properties. Our heritage is 
              built on discretion, innovation, and an unwavering commitment to representing 
            ...
            <p className="text-lg text-white/80 leading-relaxed">
              ...
              influential connections, ensuring our clients receive not just exceptional service, 
              but truly transformative real estate experiences.
            </p>
          ...
          >
            ...
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-[#0a0f1c] px-6 py-3 rounded-full border border-[#d4af37]/30 backdrop-blur-md shadow-md">
              <MapPin className="text-[#d4af37] glow-icon" size={18} />

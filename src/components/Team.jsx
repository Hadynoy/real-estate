  ...
  return (
    <section className="relative py-32 bg-[#0a0f1c] overflow-hidden text-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#d4af37]/5 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-gradient-to-tl from-[#d4af37]/5 to-transparent rounded-full blur-3xl" />
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto mb-20 text-lg">
          Meet the minds behind the mission — industry leaders with passion and
          precision.
        </p>
              ...
              >
                ...
                >
                  <div className="relative w-full h-full overflow-hidden">
                    ...
                    {isCenter && (
                      <div className="absolute inset-0 border-4 border-[#d4af37]/30 pointer-events-none" />
                    )}
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p
                      className={`text-sm uppercase tracking-widest ${
                        isCenter
                          ? "text-[#d4af37]"
                          : "text-gray-300 group-hover:text-[#d4af37]"
                      }`}
                    >
                      {member.role}
                    </p>
        ...
        <div className="mt-16">
          ...
          >
            <span className="absolute inset-0 bg-[#d4af37] transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out" />

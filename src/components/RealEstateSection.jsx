    ...
    <section className="relative w-full overflow-hidden text-white bg-[#0a0f1c] pl-6 md:pl-12 lg:pl-20">
      <div className="flex flex-col md:flex-row items-stretch">
        ...
        >
          ...
          >
            <span className="absolute inset-0 bg-[#d4af37] transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out z-0"></span>
        ...
        {/* Right: Slanted Image touching screen edge */}
        <div className="w-[50vw] h-[500px] relative">
          <div
            className="w-full h-full bg-cover bg-center ml-auto relative z-0"
            style={{ 
